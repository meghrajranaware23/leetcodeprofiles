...
Your mission today: **understand Serialization/Encoding visually** before you touch any code. Trace the tree on paper. Watch information flow. Then the recursion becomes obvious.
...
**Serialization/Encoding** — the core technique you'll use in today's quests.
