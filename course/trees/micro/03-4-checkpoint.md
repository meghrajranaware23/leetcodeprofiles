...
|---|---|---|
| [Binary Tree Level Order Traversal #102](https://leetcode.com/problems/binary-tree-level-order-traversal/) | Medium | BFS with Queue |
| [Average of Levels in Binary Tree #637](https://leetcode.com/problems/average-of-levels-in-binary-tree/) | Easy | BFS Level Computation |

---

*Day 3 complete! Tomorrow: the next branch of your ascension. →*
