...
Your mission today: **understand Tree-Graph Hybrid visually** before you touch any code. Trace the tree on paper. Watch information flow. Then the recursion becomes obvious.
...
**Tree-Graph Hybrid** — the core technique you'll use in today's quests.
