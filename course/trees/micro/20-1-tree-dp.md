...
Your mission today: **understand Tree DP visually** before you touch any code. Trace the tree on paper. Watch information flow. Then the recursion becomes obvious.
...
**Tree DP** — the core technique you'll use in today's quests.
