...
Your mission today: **understand Bottom-Up with Global Update visually** before you touch any code. Trace the tree on paper. Watch information flow. Then the recursion becomes obvious.
...
**Bottom-Up with Global Update** — the core technique you'll use in today's quests.
