...
Your mission today: **understand Morris Traversal visually** before you touch any code. Trace the tree on paper. Watch information flow. Then the recursion becomes obvious.
...
**Morris Traversal** — the core technique you'll use in today's quests.
