...
Your mission today: **understand BST Iterator/Augmentation visually** before you touch any code. Trace the tree on paper. Watch information flow. Then the recursion becomes obvious.
...
**BST Iterator/Augmentation** — the core technique you'll use in today's quests.
