...
Which pattern from today's concept applies? Think about **Reverse Inorder**.
...
Apply Reverse Inorder step by step on this tree.
...
- **"Reverse Inorder"** → Name the pattern from the concept page.
