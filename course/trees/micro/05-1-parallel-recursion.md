...
Your mission today: **understand Parallel Tree Recursion visually** before you touch any code. Trace the tree on paper. Watch information flow. Then the recursion becomes obvious.
...
**Parallel Tree Recursion** — the core technique you'll use in today's quests.
