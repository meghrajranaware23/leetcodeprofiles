...
> ⚔ **Mentor's rule:** Spend at least 5 minutes with pen and paper. Apply today's skill: **Frequency Counting**. The hints below are for *after* your attempt.

---

## The Problem

Given the problem on LeetCode, apply today's skill: **Frequency Counting**.

**[→ Open Valid Anagram on LeetCode](https://leetcode.com/problems/valid-anagram/)** for the full statement, examples, and constraints.
...
**Skill practiced today:** Frequency Counting

**Why this problem:** Frequency counting intro without heavy theory
...
1. *"I've seen this type — it's about frequency counting."*
...
|---|---|---|
| [Valid Anagram #242](https://leetcode.com/problems/valid-anagram/) | Easy | Frequency Counting |
