...
Most beginners fail here because they treat LeetCode like a speed contest. **Example Tracing & Custom Test Cases** is the foundation that separates people who quit from people who rank up. Today you build that foundation.

### 2. The skill in one sentence

> **Example Tracing & Custom Test Cases** — The examples are free answers — use them.
...
> You don't need to be fast. You need to be **systematic**. Today's skill — **Example Tracing & Custom Test Cases** — is one step in a repeatable workflow.
