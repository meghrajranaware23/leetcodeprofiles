...
> ⚔ **Mentor's rule:** Spend at least 5 minutes with pen and paper. Apply today's skill: **Familiarity Recognition**. The hints below are for *after* your attempt.
...
**[Build Array from Permutation #1920](https://leetcode.com/problems/build-array-from-permutation/)**
...
**Skill practiced today:** Familiarity Recognition

**Why this problem:** Similar family; teaches this feels like yesterday's problem
...
1. *"I've seen this type — it's about familiarity recognition."*
...
|---|---|---|
| [Build Array from Permutation #1920](https://leetcode.com/problems/build-array-from-permutation/) | Easy | Familiarity Recognition |
