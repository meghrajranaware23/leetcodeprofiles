...
**Your mission today:** *Getting stuck is data, not failure.*

**Learning objective:** Commit to genuine attempts before hints; normalize getting stuck

---

## Part 1 — Attempt-First Discipline

### 1. Why this matters

Most beginners fail here because they treat LeetCode like a speed contest. **Attempt-First Discipline** is the foundation that separates people who quit from people who rank up. Today you build that foundation.

### 2. The skill in one sentence

> **Attempt-First Discipline** — Getting stuck is data, not failure.
...
> You don't need to be fast. You need to be **systematic**. Today's skill — **Attempt-First Discipline** — is one step in a repeatable workflow.
