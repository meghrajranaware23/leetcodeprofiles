...
> **Day 11** · Problem Family Recognition · ★☆☆☆☆ · 10 XP · 8 min read

---

**Your mission today:** *You don't need 20 patterns — you need to notice repeats.*

**Learning objective:** Notice problem families without deep pattern mastery

---

## Part 1 — Problem Family Recognition

### 1. Why this matters

Most beginners fail here because they treat LeetCode like a speed contest. **Problem Family Recognition** is the foundation that separates people who quit from people who rank up. Today you build that foundation.

### 2. The skill in one sentence

> **Problem Family Recognition** — You don't need 20 patterns — you need to notice repeats.
...
> You don't need to be fast. You need to be **systematic**. Today's skill — **Problem Family Recognition** — is one step in a repeatable workflow.
