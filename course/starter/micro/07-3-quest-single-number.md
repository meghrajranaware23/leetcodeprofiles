...
> ⚔ **Mentor's rule:** Spend at least 5 minutes with pen and paper. Apply today's skill: **Isolate & Fix**. The hints below are for *after* your attempt.

---

## The Problem

Given the problem on LeetCode, apply today's skill: **Isolate & Fix**.

**[→ Open Single Number on LeetCode](https://leetcode.com/problems/single-number/)** for the full statement, examples, and constraints.
...
**Skill practiced today:** Isolate & Fix

**Why this problem:** XOR approach optional; brute force debugging path is valuable
...
1. *"I've seen this type — it's about isolate & fix."*
...
|---|---|---|
| [Single Number #136](https://leetcode.com/problems/single-number/) | Easy | Isolate & Fix |
