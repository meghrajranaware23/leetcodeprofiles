...
> ⚔ **Mentor's rule:** Spend at least 5 minutes with pen and paper. Apply today's skill: **In-Place Manipulation**. The hints below are for *after* your attempt.

---

## The Problem

Given the problem on LeetCode, apply today's skill: **In-Place Manipulation**.

**[→ Open Reverse String on LeetCode](https://leetcode.com/problems/reverse-string/)** for the full statement, examples, and constraints.
...
**Skill practiced today:** In-Place Manipulation

**Why this problem:** In-place manipulation; good first real solve
...
1. *"I've seen this type — it's about in-place manipulation."*
...
|---|---|---|
| [Reverse String #344](https://leetcode.com/problems/reverse-string/) | Easy | In-Place Manipulation |
