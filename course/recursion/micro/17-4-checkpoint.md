...
> **Pruning Strategies** · 2 quests completed · ⭐ 120 XP earned
...
|---|---|---|
| [Target Sum #494](https://leetcode.com/problems/target-sum/) | Medium | Sign-Choice Backtracking |
| [Partition to K Equal Sum Subsets #698](https://leetcode.com/problems/partition-to-k-equal-sum-subsets/) | Medium | Bucket Assignment Pruning |

---

*Day 17 complete! Tomorrow: the next descent of your ascension. →*
