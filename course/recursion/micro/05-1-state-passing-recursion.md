...
> **Day 5** · Recursion with State · ★★☆☆☆ · 10 XP · 10 min read

---

Your mission today: **understand Top-Down State Recursion visually** before you touch any code. Trace the call stack on paper. Watch values flow. Then the recursion becomes obvious.
...
**Top-Down State Recursion** — the core technique you'll use in today's quests.
