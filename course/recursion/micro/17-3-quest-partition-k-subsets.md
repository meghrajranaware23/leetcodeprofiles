...
Which pattern from today's concept applies? Think about **Bucket Assignment Pruning**.
...
**Pattern used:** Bucket Assignment Pruning
...
```
Apply Bucket Assignment Pruning step by step on the example from the problem.
...
- **"Bucket Assignment Pruning"** → Name the pattern from the concept page.
- **"What's my base case?"** → Define it before the recursive call.
- **"What does the smaller call return?"** → Trust it and combine.

If you tried brute force first, that's fine — the breakthrough is **naming the pattern family**, not memorizing one solution.

> 🎯 **Pattern Unlocked:** Bucket Assignment Pruning
