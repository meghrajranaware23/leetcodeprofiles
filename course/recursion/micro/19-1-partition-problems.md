...
Your mission today: **understand Partition Backtracking visually** before you touch any code. Trace the call stack on paper. Watch values flow. Then the recursion becomes obvious.
...
**Partition Backtracking** — the core technique you'll use in today's quests.
