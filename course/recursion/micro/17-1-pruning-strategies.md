...
Your mission today: **understand Early Termination Pruning visually** before you touch any code. Trace the call stack on paper. Watch values flow. Then the recursion becomes obvious.
...
**Early Termination Pruning** — the core technique you'll use in today's quests.
