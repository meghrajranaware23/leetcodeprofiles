...
> **Recursion with State** · 2 quests completed · ⭐ 40 XP earned
...
|---|---|---|
| [Path Sum #112](https://leetcode.com/problems/path-sum/) | Easy | Top-Down Accumulator |
| [Range Sum of BST #938](https://leetcode.com/problems/range-sum-of-bst/) | Easy | Bounded DFS |

---

*Day 5 complete! Tomorrow: the next descent of your ascension. →*
