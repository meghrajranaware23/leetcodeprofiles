...
> **Day 20** · Backtracking + String Building · ★★★★☆ · 25 XP · 15 min read

---

Your mission today: **understand Expression Generation visually** before you touch any code. Trace the call stack on paper. Watch values flow. Then the recursion becomes obvious.
...
**Expression Generation** — the core technique you'll use in today's quests.
