...
Your mission today: **understand String Partitioning visually** before you touch any code. Trace the call stack on paper. Watch values flow. Then the recursion becomes obvious.
...
**String Partitioning** — the core technique you'll use in today's quests.
