...
Your mission today: **understand Select or Skip with Capacity visually** before you touch any code. Draw the recursion tree with overlapping calls. Fill the DP table by hand. Then the transitions become obvious.
...
**Select or Skip with Capacity** — the core technique you'll use in today's quests.
...
Step 2: IDENTIFY OVERLAP
  ...
  → "Select or Skip with Capacity" has overlapping subproblems because...
...
The hardest part of DP is naming the state correctly. For **Select or Skip with Capacity**:
