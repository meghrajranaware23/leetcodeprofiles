...
Your mission today: **understand Bottom-Up Table Filling visually** before you touch any code. Draw the recursion tree with overlapping calls. Fill the DP table by hand. Then the transitions become obvious.
...
**Bottom-Up Table Filling** — the core technique you'll use in today's quests.
...
Step 2: IDENTIFY OVERLAP
  ...
  → "Bottom-Up Table Filling" has overlapping subproblems because...
...
The hardest part of DP is naming the state correctly. For **Bottom-Up Table Filling**:
