...
Your mission today: **understand String Partition DP visually** before you touch any code. Draw the recursion tree with overlapping calls. Fill the DP table by hand. Then the transitions become obvious.
...
**String Partition DP** — the core technique you'll use in today's quests.
...
Step 2: IDENTIFY OVERLAP
  ...
  → "String Partition DP" has overlapping subproblems because...
...
The hardest part of DP is naming the state correctly. For **String Partition DP**:
