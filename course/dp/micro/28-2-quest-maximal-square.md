...
Which DP pattern from today's concept applies? Think about **2D Grid DP Synthesis**.
...
**Pattern used:** 2D Grid DP Synthesis
...
- **"2D Grid DP Synthesis"** → Name the DP pattern from the concept page.
...
> 🎯 **Pattern Unlocked:** 2D Grid DP Synthesis
