...
Your mission today: **understand Speed Pattern Recognition visually** before you touch any code. Draw the recursion tree with overlapping calls. Fill the DP table by hand. Then the transitions become obvious.
...
Step 2: IDENTIFY OVERLAP
  ...
  → "Speed Pattern Recognition" has overlapping subproblems because...
...
The hardest part of DP is naming the state correctly. For **Speed Pattern Recognition**:
