...
Your mission today: **understand Constrained Shortest Path visually** before you touch any code. Draw the graph on paper. Watch nodes get visited. Then the traversal becomes obvious.
...
**Constrained Shortest Path** — the core technique you'll use in today's quests.
