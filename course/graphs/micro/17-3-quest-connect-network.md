...
Which pattern from today's concept applies? Think about **Component Counting with UF**.
...
Apply Component Counting with UF step by step on this graph.
...
- **"Component Counting with UF"** → Name the pattern from the concept page.
