...
Your mission today: **understand MST (Kruskal's/Prim's) visually** before you touch any code. Draw the graph on paper. Watch nodes get visited. Then the traversal becomes obvious.
...
**MST (Kruskal's/Prim's)** — the core technique you'll use in today's quests.
