...
Which pattern from today's concept applies? Think about **Union-Find Cycle Detection**.
...
Apply Union-Find Cycle Detection step by step on this graph.
...
- **"Union-Find Cycle Detection"** → Name the pattern from the concept page.
