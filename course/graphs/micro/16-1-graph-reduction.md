...
Your mission today: **understand Graph Transformation visually** before you touch any code. Draw the graph on paper. Watch nodes get visited. Then the traversal becomes obvious.
...
**Graph Transformation** — the core technique you'll use in today's quests.
