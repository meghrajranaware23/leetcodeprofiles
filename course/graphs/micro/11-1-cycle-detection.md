...
Your mission today: **understand Directed Cycle Detection visually** before you touch any code. Draw the graph on paper. Watch nodes get visited. Then the traversal becomes obvious.
...
**Directed Cycle Detection** — the core technique you'll use in today's quests.
