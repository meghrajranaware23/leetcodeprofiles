...
Your mission today: **understand UF Application Modeling visually** before you touch any code. Draw the graph on paper. Watch nodes get visited. Then the traversal becomes obvious.
...
**UF Application Modeling** — the core technique you'll use in today's quests.
