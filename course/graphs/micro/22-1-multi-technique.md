...
Your mission today: **understand Multi-Technique Combination visually** before you touch any code. Draw the graph on paper. Watch nodes get visited. Then the traversal becomes obvious.
...
**Multi-Technique Combination** — the core technique you'll use in today's quests.
