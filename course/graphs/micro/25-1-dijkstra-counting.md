...
Your mission today: **understand Dijkstra + Path Counting visually** before you touch any code. Draw the graph on paper. Watch nodes get visited. Then the traversal becomes obvious.
...
**Dijkstra + Path Counting** — the core technique you'll use in today's quests.
